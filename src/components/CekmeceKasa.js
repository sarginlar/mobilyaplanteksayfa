...
const CekmeceKasa = (mobilya, secilenBolge) => {
  ...
  let cekmece_alani_toplam =
    mobilya.bolge[secilenBolge].y - altBosluk - ustBosluk;
  const cekmece_alani = cekmece_alani_toplam / cekmeceAdeti;
  let baslama =
    mobilya.bolge[secilenBolge].cy -
    cekmece_alani_toplam / 2 -
    cekmece_alani / 2 +
    altBosluk / 2 -
    ustBosluk / 2;
    ...
    mobilya.cekmece_kasa[mobilya.cekmece_kasa.length] = {
      ...
      on: {
        ...
        x:
          ...
          solBosluk -
          sagBosluk -
          sol_yan_malzeme_kalinlik -
          sag_yan_malzeme_kalinlik,
        y: kasaYuksekligi,
        z: 18,
        xg0: 0,
        xg1: 0,
