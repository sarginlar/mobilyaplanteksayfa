...
*/
  ...
  */
  ...
  //@profilkapak----------------------------------------------
  const profilKapak = () => {
    const sonuc = KapakProfil(mobilya, secilenBolge)
    setmobilya({ ...mobilya, ...sonuc })
      ...
      return a.map((item, index) => {
        ...
        return (
          <mesh key={index}>
            ...
            <mesh visible userData={{ test: 'hello' }} rotation={[0, 0, 0]} position={[su.x0 / u, su.y0 / u, su.z0 / u]} castShadow>
              <planeBufferGeometry attach='geometry' args={[su.x / u, su.y / u]} />
              <meshStandardMaterial attach='material' color={color1} transparent roughness={0.1} metalness={0.1} normalMap={sol_ust_kose} />
            </mesh>
            <mesh visible userData={{ test: 'hello' }} rotation={[0, 0, 0]} position={[so.x0 / u, so.y0 / u, so.z0 / u]} castShadow>
              <planeBufferGeometry attach='geometry' args={[so.x / u, so.y / u]} />
              <meshStandardMaterial attach='material' color={color1} transparent roughness={0.1} metalness={0.1} normalMap={sol_duz} />
            </mesh>
            <mesh visible userData={{ test: 'hello' }} rotation={[0, 0, 0]} position={[sa.x0 / u, sa.y0 / u, sa.z0 / u]} castShadow>
              <planeBufferGeometry attach='geometry' args={[sa.x / u, sa.y / u]} />
              <meshStandardMaterial attach='material' color={color1} transparent roughness={0.1} metalness={0.1} normalMap={sol_alt_kose} />
            </mesh>
            <mesh visible userData={{ test: 'hello' }} rotation={[0, 0, 0]} position={[ou.x0 / u, ou.y0 / u, ou.z0 / u]} castShadow>
              <planeBufferGeometry attach='geometry' args={[ou.x / u, ou.y / u]} />
              <meshStandardMaterial attach='material' color={color1} transparent roughness={0.1} metalness={0.1} normalMap={ust_duz} />
            </mesh>
            <mesh visible userData={{ test: 'hello' }} rotation={[0, 0, 0]} position={[oo.x0 / u, oo.y0 / u, oo.z0 / u]} castShadow>
              <planeBufferGeometry attach='geometry' args={[oo.x / u, oo.y / u]} />
              <meshStandardMaterial attach='material' color={color1} transparent roughness={0.1} metalness={0.1} normalMap={orta} />
            </mesh>

            <mesh visible userData={{ test: 'hello' }} rotation={[0, 0, 0]} position={[oa.x0 / u, oa.y0 / u, oa.z0 / u]} castShadow>
              <planeBufferGeometry attach='geometry' args={[oa.x / u, oa.y / u]} />
              <meshStandardMaterial attach='material' color={color1} transparent roughness={0.1} metalness={0.1} normalMap={alt_duz} />
            </mesh>
            <mesh visible userData={{ test: 'hello' }} rotation={[0, 0, 0]} position={[suk.x0 / u, suk.y0 / u, suk.z0 / u]} castShadow>
              <planeBufferGeometry attach='geometry' args={[suk.x / u, suk.y / u]} />
              <meshStandardMaterial attach='material' color={color1} transparent roughness={0.1} metalness={0.1} normalMap={sag_ust_kose} />
            </mesh>
            <mesh visible userData={{ test: 'hello' }} rotation={[0, 0, 0]} position={[sao.x0 / u, sao.y0 / u, sao.z0 / u]} castShadow>
              <planeBufferGeometry attach='geometry' args={[sao.x / u, sao.y / u]} />
              <meshStandardMaterial attach='material' color={color1} transparent roughness={0.1} metalness={0.1} normalMap={sag_duz} />
            </mesh>
            <mesh visible userData={{ test: 'hello' }} rotation={[0, 0, 0]} position={[sak.x0 / u, sak.y0 / u, sak.z0 / u]} castShadow>
              <planeBufferGeometry attach='geometry' args={[sak.x / u, sak.y / u]} />
              <meshStandardMaterial attach='material' color={color1} transparent roughness={0.1} metalness={0.1} normalMap={sag_alt_kose} />
            </mesh>
          </mesh>
        )
      })
